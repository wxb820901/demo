...
public class ApplicationTests {
	...
	@Autowired
	private GroupXXXRepository groupXXXRepository;

	@Before
	public void deleteAllBeforeTests() throws Exception {
		groupXXXRepository.deleteAll();
	...
	public void shouldRetrieveEntity() throws Exception {
		...
		MvcResult mvcResult = mockMvc.perform(
				post("/person").content("{\"firstName\": \"Frodo\", \"lastName\":\"Baggins\"}")
		).andExpect(
				status().isCreated()
		).andReturn();
	...
	public void shouldQueryEntity() throws Exception {
		...
		mockMvc.perform(
				get("/person/search/findByLastName?name={name}", "Baggins")
		).andExpect(
				status().isOk()
		).andExpect(
	...
	@Test
	public void shouldQueryEntityById() throws Exception {
